...
logger.info('Test 4: la funcón debe resolver cualquier cantidad de números')
...
if(testsPasados === testTotales) logger.info('Todos los test pasaron correctamente')
else logger.info(`Se pasó ${testsPasados}, de un total de ${testTotales}`)